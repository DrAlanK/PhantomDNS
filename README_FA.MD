...
پروژه **phantomdns** یک پروژهٔ علمی-تحقیقاتی برای انتقال داده‌های TCP از طریق درخواست‌ها و پاسخ‌های DNS است. این پروژه در هدف کلی شبیه پروژه‌هایی مانند DNSTT یا SlipStream است، اما از نظر ساختار و روش پیاده‌سازی تفاوت‌های بنیادین دارد و رویکرد متفاوتی را دنبال می‌کند.
...
### 📊  مقایسه phantomdns با پروژه‌های مشابه:

| ویژگی | SlipStream | DNSTT | phantomdns |
| :--- | :--- | :--- | :--- |
...
پروژه phantomdns صرفاً یک ایدهٔ علمی و آموزشی است و بر همین اساس طراحی و پیاده‌سازی شده است.
...
برای دریافت آخرین اخبار، نسخه‌ها و اطلاعیه‌های پروژه، کانال تلگرام ما را دنبال کنید: [Telegram Channel](https://t.me/phantomdns)
...
نمای کلی و مختصر از قابلیت‌های اصلی phantomdns:
...
| :--- | :--- | :--- | :--- |
| ویندوز (Windows) 🪟 | `AMD64` (64-bit) | ویندوز ۱۰ و ۱۱ | [دانلود نسخه ویندوز ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_AMD64.zip) |
| ویندوز (Windows) 🪟 | `x86` (32-bit) | سیستم‌های قدیمی ۳۲ بیتی ویندوز | [دانلود نسخه ویندوز x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_X86.zip) |
| ویندوز (Windows) 🪟 | `ARM64` | دستگاه‌های ویندوزی مبتنی بر ARM | [دانلود نسخه ویندوز ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_ARM64.zip) |
| مک‌اواس (macOS) 🍎 | `ARM64` | مک‌های جدید (سری M1 / M2 / M3) | [دانلود نسخه مک (Apple Silicon) ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_MacOS_ARM64.zip) |
| مک‌اواس (macOS) 🍎 | `AMD64` | مک‌های اینتل | [دانلود نسخه مک اینتل ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_MacOS_AMD64.zip) |
| لینوکس (Linux) 🐧 | `AMD64` (64-bit) | توزیع‌های جدید (اوبونتو ۲۲.۰۴+، دبیان ۱۲+) | [دانلود نسخه لینوکس (جدید) ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_AMD64.zip) |
| لینوکس (Linux) 🐧 | `x86` (32-bit) | سیستم‌های قدیمی ۳۲ بیتی لینوکس | [دانلود نسخه لینوکس x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_X86.zip) |
| لینوکس (Legacy) 🐧 | `AMD64` (64-bit) | توزیع‌های قدیمی (اوبونتو ۲۰.۰۴، دبیان ۱۱) | [دانلود نسخه لینوکس (سازگاری بالا) ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux-Legacy_AMD64.zip) |
| لینوکس (Legacy) 🐧 | `ARM64` | سیستم‌های ARM64 قدیمی‌تر که سازگاری بیشتری می‌خواهند | [دانلود نسخه لینوکس Legacy ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux-Legacy_ARM64.zip) |
| لینوکس (ARM) 🐧 | `ARM64` | سرورهای ARM، رزبری‌پای و بردهای مشابه | [دانلود نسخه لینوکس (ARM) ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARM64.zip) |
| لینوکس (ARM) 🐧 | `ARMv7` | بردهای ARM ۳۲ بیتی و دستگاه‌های قدیمی‌تر | [دانلود نسخه لینوکس ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV7.zip) |
| لینوکس (ARM) 🐧 | `ARMv6` | بردهای ARM قدیمی‌تر و سیستم‌های سبک لینوکسی | [دانلود نسخه لینوکس ARMv6 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV6.zip) |
| لینوکس (ARM) 🐧 | `ARMv5` | دستگاه‌های ARM خیلی قدیمی و سیستم‌های embedded | [دانلود نسخه لینوکس ARMv5 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV5.zip) |
| لینوکس (Linux) 🐧 | `RISCV64` | بردها و سرورهای لینوکسی مبتنی بر RISC-V | [دانلود نسخه لینوکس RISCV64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_RISCV64.zip) |
| لینوکس (MIPS) 🐧 | `MIPS` | سیستم‌ها و روترهای لینوکسی MIPS با endian بزرگ | [دانلود نسخه لینوکس MIPS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS.zip) |
| لینوکس (MIPS) 🐧 | `MIPSLE` | سیستم‌ها و روترهای لینوکسی MIPS با endian کوچک | [دانلود نسخه لینوکس MIPSLE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPSLE.zip) |
| لینوکس (MIPS) 🐧 | `MIPS64` | سیستم‌های ۶۴ بیتی MIPS با endian بزرگ | [دانلود نسخه لینوکس MIPS64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS64.zip) |
| لینوکس (MIPS) 🐧 | `MIPS64LE` | سیستم‌های ۶۴ بیتی MIPS با endian کوچک | [دانلود نسخه لینوکس MIPS64LE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS64LE.zip) |
| ترموکس / اندروید 📱 | `ARM64` | گوشی‌های اندرویدی جدید با Termux | [دانلود نسخه ترموکس ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Termux_ARM64.zip) |
| ترموکس / اندروید 📱 | `ARMv7` | گوشی‌های قدیمی‌تر با محیط ۳۲ بیتی Termux | [دانلود نسخه ترموکس ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Termux_ARMV7.zip) |
...
| سیستم‌عامل (OS) | پردازنده (Architecture) | مناسب برای سیستم‌های... | لینک دانلود مستقیم |
| :--- | :--- | :--- | :--- |
| ویندوز (Windows) 🪟 | `AMD64` (64-bit) | ویندوز سرور، ویندوز ۱۰ و ۱۱ | [دانلود سرور ویندوز ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_AMD64.zip) |
| ویندوز (Windows) 🪟 | `x86` (32-bit) | سیستم‌های قدیمی ۳۲ بیتی ویندوز | [دانلود سرور ویندوز x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_X86.zip) |
| ویندوز (Windows) 🪟 | `ARM64` | دستگاه‌های ویندوزی مبتنی بر ARM | [دانلود سرور ویندوز ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_ARM64.zip) |
| لینوکس (Linux) 🐧 | `AMD64` (64-bit) | سرورهای اوبونتو ۲۲.۰۴+، دبیان ۱۲+ | [دانلود سرور لینوکس (جدید) ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_AMD64.zip) |
| لینوکس (Linux) 🐧 | `x86` (32-bit) | سیستم‌های قدیمی ۳۲ بیتی لینوکس | [دانلود سرور لینوکس x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_X86.zip) |
| لینوکس (Legacy) 🐧 | `AMD64` (64-bit) | سرورهای قدیمی (اوبونتو ۲۰.۰۴، دبیان ۱۱) | [دانلود سرور لینوکس (سازگاری بالا) ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux-Legacy_AMD64.zip) |
| لینوکس (Legacy) 🐧 | `ARM64` | سیستم‌های ARM64 قدیمی‌تر که سازگاری بیشتری می‌خواهند | [دانلود سرور لینوکس Legacy ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux-Legacy_ARM64.zip) |
| لینوکس (ARM) 🐧 | `ARM64` | سرورهای ARM | [دانلود سرور لینوکس (ARM) ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARM64.zip) |
| لینوکس (ARM) 🐧 | `ARMv7` | سرورهای ARM ۳۲ بیتی و دستگاه‌های embedded | [دانلود سرور لینوکس ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV7.zip) |
| لینوکس (ARM) 🐧 | `ARMv6` | بردهای ARM قدیمی‌تر و سیستم‌های سبک لینوکسی | [دانلود سرور لینوکس ARMv6 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV6.zip) |
| لینوکس (ARM) 🐧 | `ARMv5` | دستگاه‌های ARM خیلی قدیمی و سیستم‌های embedded | [دانلود سرور لینوکس ARMv5 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV5.zip) |
| لینوکس (Linux) 🐧 | `RISCV64` | بردها و سرورهای لینوکسی مبتنی بر RISC-V | [دانلود سرور لینوکس RISCV64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_RISCV64.zip) |
| لینوکس (MIPS) 🐧 | `MIPS` | سیستم‌ها و روترهای لینوکسی MIPS با endian بزرگ | [دانلود سرور لینوکس MIPS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS.zip) |
| لینوکس (MIPS) 🐧 | `MIPSLE` | سیستم‌ها و روترهای لینوکسی MIPS با endian کوچک | [دانلود سرور لینوکس MIPSLE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPSLE.zip) |
| لینوکس (MIPS) 🐧 | `MIPS64` | سیستم‌های ۶۴ بیتی MIPS با endian بزرگ | [دانلود سرور لینوکس MIPS64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS64.zip) |
| لینوکس (MIPS) 🐧 | `MIPS64LE` | سیستم‌های ۶۴ بیتی MIPS با endian کوچک | [دانلود سرور لینوکس MIPS64LE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS64LE.zip) |
| مک‌اواس (macOS) 🍎 | `ARM64` | مک‌های جدید (سری M1 / M2 / M3) | [دانلود سرور مک (Apple Silicon) ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_MacOS_ARM64.zip) |
| مک‌اواس (macOS) 🍎 | `AMD64` | مک‌های اینتل | [دانلود سرور مک اینتل ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_MacOS_AMD64.zip) |
| ترموکس / اندروید 📱 | `ARM64` | محیط‌های جدید اندروید / Termux | [دانلود سرور ترموکس ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Termux_ARM64.zip) |
| ترموکس / اندروید 📱 | `ARMv7` | محیط‌های قدیمی‌تر اندروید / Termux ۳۲ بیتی | [دانلود سرور ترموکس ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Termux_ARMV7.zip) |

---

### بخش ۲.۲: 📦 ایمیج Docker مربوط به phantomdns

---

#### بخش ۲.۲.۱: ⚠️ نمای کلی

این ایمیج Docker سرور phantomdns را در یک محیط کانتینری اجرا می‌کند و از ساخت‌های چندمعماری پشتیبانی می‌کند.
...
- سپس فایل `phantomdns_Client_Windows_AMD64.exe` را اجرا کنید. اگر همه چیز درست تنظیم شده باشد، کلاینت به سرور متصل می‌شود و آماده استفاده است.
...
```bash
sudo nano /etc/systemd/system/phantomdns-client.service
```
...
```ini
[Unit]
Description=phantomdns Client Service
After=network.target
[Service]
Type=simple
ExecStart=/path/to/phantomdns_Client_Linux_AMD64 -config /path/to/client_config.toml
Restart=on-failure
[Install]
...
sudo systemctl enable phantomdns-client
sudo systemctl start phantomdns-client
```

همچنین برای دیدن لاگ‌ها می‌توانید از دستور زیر استفاده کنید:

```bash
sudo journalctl -u phantomdns-client -f
```
...
- سپس فایل `phantomdns_Client_MacOS_ARM64` را اجرا کنید. اگر همه چیز درست تنظیم شده باشد، کلاینت به سرور متصل می‌شود و آماده استفاده است.
...
| `MTU_SERVERS_FILE_NAME` | `"phantomdns_success_test_{time}.log"` | رشته | نام فایل خروجی لاگ تست MTU.<br>معمولاً placeholderهایی مثل `{time}` داخلش استفاده می‌شود تا هر run فایل جدا داشته باشد. |
...
اگر روی یک سرور، پنل یا سرویس دیگری دارید، می‌توانید outbound آن را به SOCKS5 لوکال کلاینت phantomdns بدهید و از آن به‌عنوان مسیر خروجی استفاده کنید.
...
در این بخش چند پروژه مرتبط با phantomdns را معرفی می‌کنیم که توسط افراد مختلف توسعه داده شده‌اند و می‌توانند برای استفاده یا الهام گرفتن مفید باشند، البته توجه داشته باشید که این پروژه‌ها مستقل از phantomdns هستند و ممکن است با آن متفاوت باشند یا ویژگی‌های خاص خود را داشته باشند.
...
- [کلاینت اندروید MDV HN Edition](https://github.com/Hidden-Node/phantomdns-AndroidClient)
> یک اپلیکیشن اندروید که بر مبنای phantomdns ساخته شده که امکان اتصال به سرورهای phantomdns را از طریق گوشی فراهم می‌کند. این پروژه توسط Hidden Node توسعه داده شده است و می‌توانید آن را در لینک بالا مشاهده کنید.

- [کلاینت اندروید phantomdns GG](https://github.com/RevocGG/phantomdns-AndroidGG)
> یک اپلیکیشن اندروید دیگر که بر مبنای phantomdns ساخته شده است. این پروژه توسط RevocGG توسعه داده شده است و می‌توانید آن را در لینک بالا مشاهده کنید.

- [ابزار ساخت کانفیگ فارسی برای phantomdns](https://github.com/datacoder-io/phantomdns-ConfigMaker) - [آدرس وب جهت ساخت کانفیگ](https://datacoder-io.github.io/phantomdns-ConfigMaker)
> این ابزار به شما کمک می‌کند تا کانفیگ‌های phantomdns را به زبان فارسی و با توضیحات کامل بسازید. این پروژه توسط datacoder-io توسعه داده شده است و می‌توانید آن را در لینک بالا مشاهده کنید.

- [MasterDnsWeb (کلاینت مدیریت تحت وب)](https://github.com/abolix/MasterDnsWeb)
> یک پروژه تحت وب برای مدیریت آسان phantomdns و مدیریت هم‌زمان یک یا چندین Instance. این پروژه به‌صورت مستقل توسط Abolix توسعه داده شده است.

- [KevinNet DNS](https://github.com/kamalalhagh/kevinnet-dns)
> ابزاری برای پیدا کردن و بررسی DNS Resolverهای فعال برای phantomdns، مخصوصاً برای کاربران داخل ایران. این ابزار کانفیگ‌های آماده استفاده تولید می‌کند و اتصال را به‌صورت کامل (End-to-End) تست می‌کند. این پروژه به‌صورت مستقل توسط Kevin Haji توسعه داده شده است.
...
شما به راحتی میتوانید کلاینت phantomdns را به عنوان یک پروکسی محلی در پنل‌هایی مثل 3X-UI یا هر پنل دیگری که از پروکسی‌های محلی پشتیبانی می‌کند، استفاده کنید. برای اینکار کافیست در تنظیمات کلاینت

برای اینکار مراحل زیر را دنبال کنید.

- کلاینت phantomdns را روی سرور یا سیستمی که پنل شما روی آن است اجرا کنید.
...
- و یک Tag دلخواه برای این Outbound انتخاب کنید (مثلاً phantomdns-Out).
- در بخش Address، آدرس IP لوکال کلاینت phantomdns را وارد کنید (اگر روی همان سرور است معمولاً `127.0.0.1` است).
- در بخش Port، پورتی که در `client_config.toml` برای `LISTEN_PORT` تنظیم کرده‌اید را وارد کنید (مثلاً `18000`).
- اگر در تنظیمات phantomdns برای پروکسی احراز هویت گذاشته‌اید، در اینجا هم باید همان نام کاربری و رمز عبور را وارد کنید.
...
- در بخش Outbound Tags، Outboundی که برای phantomdns ساخته‌اید را انتخاب کنید.
- حالا روی Add Rule کلیک کنید تا قانون ساخته شود.
- روی گزینه Save و Restart Xray کلیک کنید تا تنظیمات اعمال شود.

حالا هر ترافیکی که به آن Inbound می‌آید، از طریق کلاینت phantomdns به سرور تونل DNS شما فرستاده می‌شود و از آنجا به مقصد نهایی می‌رود.

---

## بخش ۶: 🛠️ معماری و نحوهٔ کار سیستم

پروژه **phantomdns** با ترکیب Session Multiplexing، Resolver Balancing، Packet Duplication، لایه‌ی ARQ اختصاصی و Deferred Session Runtime روی بستر UDP/DNS محدودیت‌های تونل‌های معمول را دور می‌زند.
...
توسعه‌داده‌شده با ❤️ توسط: [**DrAlanK**](https://github.com/DrAlanK)
