...
**phantomdns** es un proyecto científico y orientado a la investigación para transportar tráfico TCP a través de consultas y respuestas DNS. En su objetivo general, es similar a proyectos como DNSTT o SlipStream, pero sigue una estructura y un enfoque de implementación fundamentalmente diferentes.
...
### 📊 phantomdns Comparado con Proyectos Similares

| Característica | SlipStream | DNSTT | phantomdns |
| :--- | :--- | :--- | :--- |
...
phantomdns se proporciona únicamente como un proyecto educativo y de investigación.
...
Para conocer las últimas noticias, lanzamientos y novedades del proyecto, sigue nuestro canal de Telegram: [Canal de Telegram](https://t.me/phantomdns)
...
Una breve descripción de las principales capacidades de phantomdns:
...
phantomdns no es solo un proyecto teórico. Está probado en combate y se ha demostrado que funciona en entornos donde internet global está completamente cortado.
...
Las herramientas de elusión estándar son inútiles cuando no hay internet internacional al que conectarse. Sin embargo, durante este cierre masivo, phantomdns destacó como uno de los muy pocos salvavidas que realmente mantuvo a los usuarios conectados a la red global.

**¿Cómo sobrevivió a un apagón total?**
En lugar de actuar como una VPN estándar, phantomdns se basa en técnicas inteligentes de tunelización DNS para atravesar el apagón:
...
Esta combinación exacta es lo que permitió a phantomdns mantener una conexión estable cuando el mundo exterior estaba completamente bloqueado.
...
| :--- | :--- | :--- | :--- |
| Windows 🪟 | `AMD64` (64 bits) | Windows 10 y 11 | [Descargar Cliente Windows ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_AMD64.zip) |
| Windows 🪟 | `x86` (32 bits) | Sistemas Windows antiguos de 32 bits | [Descargar Cliente Windows x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_X86.zip) |
| Windows 🪟 | `ARM64` | Windows en dispositivos ARM | [Descargar Cliente Windows ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_ARM64.zip) |
| macOS 🍎 | `ARM64` | Macs con Apple Silicon (M1 / M2 / M3) | [Descargar Cliente macOS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_MacOS_ARM64.zip) |
| macOS 🍎 | `AMD64` | Macs con Intel | [Descargar Cliente macOS Intel ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_MacOS_AMD64.zip) |
| Linux 🐧 | `AMD64` (64 bits) | Distribuciones modernas (Ubuntu 22.04+, Debian 12+) | [Descargar Cliente Linux ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_AMD64.zip) |
| Linux 🐧 | `x86` (32 bits) | Sistemas Linux antiguos de 32 bits | [Descargar Cliente Linux x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_X86.zip) |
| Linux (Legacy) 🐧 | `AMD64` (64 bits) | Distribuciones antiguas (Ubuntu 20.04, Debian 11) | [Descargar Cliente Linux Legacy ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux-Legacy_AMD64.zip) |
| Linux (Legacy) 🐧 | `ARM64` | Sistemas Linux ARM64 antiguos que necesitan mayor compatibilidad | [Descargar Cliente Linux Legacy ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux-Legacy_ARM64.zip) |
| Linux (ARM) 🐧 | `ARM64` | Servidores ARM, Raspberry Pi y placas similares | [Descargar Cliente Linux ARM ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARM64.zip) |
| Linux (ARM) 🐧 | `ARMv7` | Placas ARM de 32 bits y dispositivos Linux embebidos antiguos | [Descargar Cliente Linux ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV7.zip) |
| Linux (ARM) 🐧 | `ARMv6` | Placas ARM antiguas y dispositivos Linux ligeros | [Descargar Cliente Linux ARMv6 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV6.zip) |
| Linux (ARM) 🐧 | `ARMv5` | Dispositivos ARM muy antiguos y sistemas Linux embebidos | [Descargar Cliente Linux ARMv5 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV5.zip) |
| Linux 🐧 | `RISCV64` | Placas y servidores Linux RISC-V | [Descargar Cliente Linux RISCV64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_RISCV64.zip) |
| Linux (MIPS) 🐧 | `MIPS` | Linux MIPS big-endian y plataformas de routers | [Descargar Cliente Linux MIPS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS.zip) |
| Linux (MIPS) 🐧 | `MIPSLE` | Linux MIPS little-endian y plataformas de routers | [Descargar Cliente Linux MIPSLE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPSLE.zip) |
| Linux (MIPS) 🐧 | `MIPS64` | Sistemas Linux MIPS big-endian de 64 bits | [Descargar Cliente Linux MIPS64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS64.zip) |
| Linux (MIPS) 🐧 | `MIPS64LE` | Sistemas Linux MIPS little-endian de 64 bits | [Descargar Cliente Linux MIPS64LE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS64LE.zip) |
| Termux / Android 📱 | `ARM64` | Teléfonos Android modernos con Termux | [Descargar Cliente Termux ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Termux_ARM64.zip) |
| Termux / Android 📱 | `ARMv7` | Teléfonos Android antiguos con entornos Termux de 32 bits | [Descargar Cliente Termux ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Termux_ARMV7.zip) |
...
| Sistema Operativo | Arquitectura | Adecuado para | Descarga directa |
| :--- | :--- | :--- | :--- |
| Windows 🪟 | `AMD64` (64 bits) | Windows Server, Windows 10 y 11 | [Descargar Servidor Windows ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_AMD64.zip) |
| Windows 🪟 | `x86` (32 bits) | Sistemas Windows antiguos de 32 bits | [Descargar Servidor Windows x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_X86.zip) |
| Windows 🪟 | `ARM64` | Windows en dispositivos ARM | [Descargar Servidor Windows ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_ARM64.zip) |
| Linux 🐧 | `AMD64` (64 bits) | Servidores Ubuntu 22.04+, Debian 12+ | [Descargar Servidor Linux ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_AMD64.zip) |
| Linux 🐧 | `x86` (32 bits) | Sistemas Linux antiguos de 32 bits | [Descargar Servidor Linux x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_X86.zip) |
| Linux (Legacy) 🐧 | `AMD64` (64 bits) | Servidores antiguos (Ubuntu 20.04, Debian 11) | [Descargar Servidor Linux Legacy ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux-Legacy_AMD64.zip) |
| Linux (Legacy) 🐧 | `ARM64` | Sistemas Linux ARM64 antiguos que necesitan mayor compatibilidad | [Descargar Servidor Linux Legacy ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux-Legacy_ARM64.zip) |
| Linux (ARM) 🐧 | `ARM64` | Servidores ARM | [Descargar Servidor Linux ARM ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARM64.zip) |
| Linux (ARM) 🐧 | `ARMv7` | Servidores ARM de 32 bits y dispositivos Linux embebidos | [Descargar Servidor Linux ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV7.zip) |
| Linux (ARM) 🐧 | `ARMv6` | Placas ARM antiguas y dispositivos Linux ligeros | [Descargar Servidor Linux ARMv6 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV6.zip) |
| Linux (ARM) 🐧 | `ARMv5` | Dispositivos ARM muy antiguos y sistemas Linux embebidos | [Descargar Servidor Linux ARMv5 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV5.zip) |
| Linux 🐧 | `RISCV64` | Placas y servidores Linux RISC-V | [Descargar Servidor Linux RISCV64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_RISCV64.zip) |
| Linux (MIPS) 🐧 | `MIPS` | Linux MIPS big-endian y plataformas de routers | [Descargar Servidor Linux MIPS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS.zip) |
| Linux (MIPS) 🐧 | `MIPSLE` | Linux MIPS little-endian y plataformas de routers | [Descargar Servidor Linux MIPSLE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPSLE.zip) |
| Linux (MIPS) 🐧 | `MIPS64` | Sistemas Linux MIPS big-endian de 64 bits | [Descargar Servidor Linux MIPS64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS64.zip) |
| Linux (MIPS) 🐧 | `MIPS64LE` | Sistemas Linux MIPS little-endian de 64 bits | [Descargar Servidor Linux MIPS64LE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS64LE.zip) |
| macOS 🍎 | `ARM64` | Macs con Apple Silicon | [Descargar Servidor macOS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_MacOS_ARM64.zip) |
| macOS 🍎 | `AMD64` | Macs con Intel | [Descargar Servidor macOS Intel ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_MacOS_AMD64.zip) |
| Termux / Android 📱 | `ARM64` | Entornos Android / Termux modernos | [Descargar Servidor Termux ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Termux_ARM64.zip) |
| Termux / Android 📱 | `ARMv7` | Entornos Android antiguos / Termux de 32 bits | [Descargar Servidor Termux ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Termux_ARMV7.zip) |

---

### Sección 2.2: 📦 Imagen Docker de phantomdns

---

#### Sección 2.2.1: ⚠️ Descripción general

Esta imagen Docker ejecuta el servidor phantomdns en un entorno en contenedor y admite compilaciones multiarquitectura.
...
| `MTU_SERVERS_FILE_NAME` | `"phantomdns_success_test_{time}.log"` | cadena | Plantilla del nombre del archivo de salida para los resolutores con MTU probada con éxito. |
...
Si ya tienes otro panel o servicio en un servidor, puedes apuntar su ruta saliente al SOCKS5 local del cliente phantomdns y usarlo como ruta de salida.
...
### Sección 5.1: Proyectos de la Comunidad Relacionados con phantomdns 🧩

En esta sección, presentamos algunos proyectos relacionados con phantomdns que han sido desarrollados por otras personas. Pueden ser útiles para uso práctico, inspiración o experimentación. Ten en cuenta que estos proyectos son independientes de phantomdns en sí y pueden comportarse de forma diferente o incluir sus propias características y decisiones de diseño adicionales.
...
- [MDV HN Edition Android Client](https://github.com/Hidden-Node/phantomdns-AndroidClient)
  Una aplicación de Android construida en torno a phantomdns que permite conectarse a servidores phantomdns desde un teléfono. Este proyecto es desarrollado de forma independiente por Hidden Node.

- [phantomdns GG Android Client](https://github.com/RevocGG/phantomdns-AndroidGG)
  Otro cliente de Android construido en torno a phantomdns. Este proyecto es desarrollado de forma independiente por RevocGG.
...
- [Persian Config Builder for phantomdns](https://github.com/datacoder-io/phantomdns-ConfigMaker) - [Web Config Builder](https://datacoder-io.github.io/phantomdns-ConfigMaker)
  Una herramienta que ayuda a crear archivos de configuración de phantomdns con explicaciones en persa y una interfaz guiada. Este proyecto es desarrollado de forma independiente por datacoder-io.

- [MasterDnsWeb (Web Management Client)](https://github.com/abolix/MasterDnsWeb)
  Un cliente de gestión basado en web para phantomdns, diseñado para facilitar la gestión de una o varias instancias al mismo tiempo. Desarrollado de forma independiente por Abolix.

- [KevinNet DNS](https://github.com/kamalalhagh/kevinnet-dns)
  Una herramienta complementaria para phantomdns que descubre y valida resolutores DNS operativos, especialmente para usuarios en Irán. Genera archivos de configuración listos para usar y realiza una verificación de túnel de extremo a extremo. Este proyecto es desarrollado de forma independiente por Kevin Haji.
...
Puedes usar el cliente phantomdns como un proxy local dentro de paneles como 3X-UI o cualquier otro sistema que admita proxies de salida locales.
Sigue estos pasos:

- Ejecuta el cliente phantomdns en el mismo servidor donde se ejecuta tu panel.
...
- Elige una etiqueta (por ejemplo: `phantomdns-Out`).
- En **Address**, introduce la IP local del cliente phantomdns (normalmente `127.0.0.1`).
- En **Port**, introduce el `LISTEN_PORT` que estableciste en `client_config.toml` (por ejemplo `18000`).
- Si la autenticación SOCKS está activada en phantomdns, introduce aquí el mismo usuario/contraseña.
...
- En **Outbound Tags**, selecciona la etiqueta `phantomdns-Out`.
- Haz clic en **Save** y **Restart Xray**.

Ahora todo el tráfico de ese inbound pasará por phantomdns y saldrá a través de tu túnel DNS.

---

## Sección 6: 🛠️ Arquitectura del Sistema y Cómo Funciona

**phantomdns** combina Multiplexación de Sesiones, Balanceo de Resolutores, Duplicación de Paquetes, una capa ARQ personalizada y un Runtime de Sesión Diferida sobre UDP/DNS para evitar las limitaciones habituales de los túneles ordinarios.
...
Desarrollado con ❤️ por: [**DrAlanK**](https://github.com/DrAlanK)
