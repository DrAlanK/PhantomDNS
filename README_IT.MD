...
**phantomdns** è un progetto a carattere scientifico e di ricerca per trasportare traffico TCP attraverso query e risposte DNS. Nell'obiettivo generale, è simile a progetti come DNSTT o SlipStream, ma segue una struttura e un approccio implementativo fondamentalmente diversi.
...
### 📊 phantomdns a Confronto con Progetti Simili

| Caratteristica | SlipStream | DNSTT | phantomdns |
| :--- | :--- | :--- | :--- |
...
phantomdns è fornito esclusivamente come progetto educativo e di ricerca.
...
Per le ultime notizie, i rilasci e gli aggiornamenti del progetto, segui il nostro canale Telegram: [Canale Telegram](https://t.me/phantomdns)
...
Una breve panoramica delle principali capacità di phantomdns:
...
phantomdns non è solo un progetto teorico. È collaudato sul campo e ha dimostrato di funzionare in ambienti in cui Internet globale è completamente reciso.
...
Gli strumenti di elusione standard sono inutili quando non c'è alcun Internet internazionale a cui connettersi. Eppure, durante questo enorme blocco, phantomdns si è distinto come una delle pochissime ancore di salvezza che hanno effettivamente mantenuto gli utenti connessi al web globale.

**Come è sopravvissuto a un blocco totale?**
Invece di comportarsi come una VPN standard, phantomdns si affida a tecniche intelligenti di tunneling DNS per penetrare il blackout:
...
È esattamente questa combinazione che ha permesso a phantomdns di mantenere una connessione stabile quando il mondo esterno era completamente bloccato.
...
| :--- | :--- | :--- | :--- |
| Windows 🪟 | `AMD64` (64-bit) | Windows 10 e 11 | [Scarica Client Windows ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_AMD64.zip) |
| Windows 🪟 | `x86` (32-bit) | Sistemi Windows a 32-bit più vecchi | [Scarica Client Windows x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_X86.zip) |
| Windows 🪟 | `ARM64` | Dispositivi Windows su ARM | [Scarica Client Windows ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Windows_ARM64.zip) |
| macOS 🍎 | `ARM64` | Mac con Apple Silicon (M1 / M2 / M3) | [Scarica Client macOS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_MacOS_ARM64.zip) |
| macOS 🍎 | `AMD64` | Mac con Intel | [Scarica Client macOS Intel ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_MacOS_AMD64.zip) |
| Linux 🐧 | `AMD64` (64-bit) | Distribuzioni moderne (Ubuntu 22.04+, Debian 12+) | [Scarica Client Linux ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_AMD64.zip) |
| Linux 🐧 | `x86` (32-bit) | Sistemi Linux a 32-bit più vecchi | [Scarica Client Linux x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_X86.zip) |
| Linux (Legacy) 🐧 | `AMD64` (64-bit) | Distribuzioni più vecchie (Ubuntu 20.04, Debian 11) | [Scarica Client Linux Legacy ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux-Legacy_AMD64.zip) |
| Linux (Legacy) 🐧 | `ARM64` | Sistemi Linux ARM64 più vecchi che necessitano di maggiore compatibilità | [Scarica Client Linux Legacy ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux-Legacy_ARM64.zip) |
| Linux (ARM) 🐧 | `ARM64` | Server ARM, Raspberry Pi e schede simili | [Scarica Client Linux ARM ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARM64.zip) |
| Linux (ARM) 🐧 | `ARMv7` | Schede ARM a 32-bit e dispositivi Linux embedded più vecchi | [Scarica Client Linux ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV7.zip) |
| Linux (ARM) 🐧 | `ARMv6` | Schede ARM più vecchie e dispositivi Linux leggeri | [Scarica Client Linux ARMv6 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV6.zip) |
| Linux (ARM) 🐧 | `ARMv5` | Dispositivi ARM molto vecchi e sistemi Linux embedded | [Scarica Client Linux ARMv5 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_ARMV5.zip) |
| Linux 🐧 | `RISCV64` | Schede e server Linux RISC-V | [Scarica Client Linux RISCV64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_RISCV64.zip) |
| Linux (MIPS) 🐧 | `MIPS` | Linux MIPS big-endian e piattaforme router | [Scarica Client Linux MIPS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS.zip) |
| Linux (MIPS) 🐧 | `MIPSLE` | Linux MIPS little-endian e piattaforme router | [Scarica Client Linux MIPSLE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPSLE.zip) |
| Linux (MIPS) 🐧 | `MIPS64` | Sistemi Linux MIPS big-endian a 64-bit | [Scarica Client Linux MIPS64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS64.zip) |
| Linux (MIPS) 🐧 | `MIPS64LE` | Sistemi Linux MIPS little-endian a 64-bit | [Scarica Client Linux MIPS64LE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Linux_MIPS64LE.zip) |
| Termux / Android 📱 | `ARM64` | Telefoni Android moderni con Termux | [Scarica Client Termux ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Termux_ARM64.zip) |
| Termux / Android 📱 | `ARMv7` | Telefoni Android più vecchi con ambienti Termux a 32-bit | [Scarica Client Termux ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Client_Termux_ARMV7.zip) |
...
| Sistema Operativo | Architettura | Adatto Per | Download Diretto |
| :--- | :--- | :--- | :--- |
| Windows 🪟 | `AMD64` (64-bit) | Windows Server, Windows 10 e 11 | [Scarica Server Windows ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_AMD64.zip) |
| Windows 🪟 | `x86` (32-bit) | Sistemi Windows a 32-bit più vecchi | [Scarica Server Windows x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_X86.zip) |
| Windows 🪟 | `ARM64` | Dispositivi Windows su ARM | [Scarica Server Windows ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Windows_ARM64.zip) |
| Linux 🐧 | `AMD64` (64-bit) | Server Ubuntu 22.04+, Debian 12+ | [Scarica Server Linux ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_AMD64.zip) |
| Linux 🐧 | `x86` (32-bit) | Sistemi Linux a 32-bit più vecchi | [Scarica Server Linux x86 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_X86.zip) |
| Linux (Legacy) 🐧 | `AMD64` (64-bit) | Server più vecchi (Ubuntu 20.04, Debian 11) | [Scarica Server Linux Legacy ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux-Legacy_AMD64.zip) |
| Linux (Legacy) 🐧 | `ARM64` | Sistemi Linux ARM64 più vecchi che necessitano di maggiore compatibilità | [Scarica Server Linux Legacy ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux-Legacy_ARM64.zip) |
| Linux (ARM) 🐧 | `ARM64` | Server ARM | [Scarica Server Linux ARM ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARM64.zip) |
| Linux (ARM) 🐧 | `ARMv7` | Server ARM a 32-bit e dispositivi Linux embedded | [Scarica Server Linux ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV7.zip) |
| Linux (ARM) 🐧 | `ARMv6` | Schede ARM più vecchie e dispositivi Linux leggeri | [Scarica Server Linux ARMv6 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV6.zip) |
| Linux (ARM) 🐧 | `ARMv5` | Dispositivi ARM molto vecchi e sistemi Linux embedded | [Scarica Server Linux ARMv5 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_ARMV5.zip) |
| Linux 🐧 | `RISCV64` | Schede e server Linux RISC-V | [Scarica Server Linux RISCV64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_RISCV64.zip) |
| Linux (MIPS) 🐧 | `MIPS` | Linux MIPS big-endian e piattaforme router | [Scarica Server Linux MIPS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS.zip) |
| Linux (MIPS) 🐧 | `MIPSLE` | Linux MIPS little-endian e piattaforme router | [Scarica Server Linux MIPSLE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPSLE.zip) |
| Linux (MIPS) 🐧 | `MIPS64` | Sistemi Linux MIPS big-endian a 64-bit | [Scarica Server Linux MIPS64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS64.zip) |
| Linux (MIPS) 🐧 | `MIPS64LE` | Sistemi Linux MIPS little-endian a 64-bit | [Scarica Server Linux MIPS64LE ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Linux_MIPS64LE.zip) |
| macOS 🍎 | `ARM64` | Mac con Apple Silicon | [Scarica Server macOS ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_MacOS_ARM64.zip) |
| macOS 🍎 | `AMD64` | Mac con Intel | [Scarica Server macOS Intel ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_MacOS_AMD64.zip) |
| Termux / Android 📱 | `ARM64` | Ambienti Android / Termux moderni | [Scarica Server Termux ARM64 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Termux_ARM64.zip) |
| Termux / Android 📱 | `ARMv7` | Ambienti Android / Termux a 32-bit più vecchi | [Scarica Server Termux ARMv7 ⬇️](https://github.com/DrAlanK/phantomdns/releases/latest/download/phantomdns_Server_Termux_ARMV7.zip) |

---

### Sezione 2.2: 📦 Immagine Docker di phantomdns

---

#### Sezione 2.2.1: ⚠️ Panoramica

Questa immagine Docker esegue il server phantomdns in un ambiente containerizzato e supporta build multi-architettura.
...
| `MTU_SERVERS_FILE_NAME` | `"phantomdns_success_test_{time}.log"` | stringa | Modello del nome del file di output per i resolver testati con successo per l'MTU. |
...
Se hai già un altro pannello o servizio su un server, puoi puntare il suo percorso in uscita verso il SOCKS5 locale del client phantomdns e usarlo come percorso di uscita.
...
### Sezione 5.1: Progetti della Community Relativi a phantomdns 🧩

In questa sezione presentiamo alcuni progetti relativi a phantomdns che sono stati sviluppati da altre persone. Possono essere utili per l'uso pratico, l'ispirazione o la sperimentazione. Si prega di notare che questi progetti sono indipendenti da phantomdns stesso e possono comportarsi diversamente o includere proprie funzionalità aggiuntive e scelte di progettazione.
...
- [MDV HN Edition Android Client](https://github.com/Hidden-Node/phantomdns-AndroidClient)
  Un'applicazione Android costruita attorno a phantomdns che consente di connettersi ai server phantomdns da un telefono. Questo progetto è sviluppato indipendentemente da Hidden Node.

- [phantomdns GG Android Client](https://github.com/RevocGG/phantomdns-AndroidGG)
  Un altro client Android costruito attorno a phantomdns. Questo progetto è sviluppato indipendentemente da RevocGG.
...
- [Persian Config Builder for phantomdns](https://github.com/datacoder-io/phantomdns-ConfigMaker) - [Web Config Builder](https://datacoder-io.github.io/phantomdns-ConfigMaker)
  Uno strumento che aiuta a creare file di configurazione di phantomdns con spiegazioni in persiano e un'interfaccia guidata. Questo progetto è sviluppato indipendentemente da datacoder-io.

- [MasterDnsWeb (Web Management Client)](https://github.com/abolix/MasterDnsWeb)
  Un client di gestione basato sul web per phantomdns, progettato per rendere facile la gestione di una o più istanze contemporaneamente. Sviluppato indipendentemente da Abolix.

- [KevinNet DNS](https://github.com/kamalalhagh/kevinnet-dns)
  Uno strumento complementare per phantomdns che scopre e convalida resolver DNS funzionanti, specialmente per gli utenti in Iran. Genera file di configurazione pronti all'uso ed esegue la verifica end-to-end del tunnel. Questo progetto è sviluppato indipendentemente da Kevin Haji.
...
Puoi usare il client phantomdns come proxy locale all'interno di pannelli come 3X-UI o qualsiasi altro sistema che supporti proxy locali in uscita.
Segui questi passi:

- Esegui il client phantomdns sullo stesso server dove è in esecuzione il tuo pannello.
...
- Scegli un tag (ad esempio: `phantomdns-Out`).
- In **Address**, inserisci l'IP locale del client phantomdns (di solito `127.0.0.1`).
- In **Port**, inserisci la `LISTEN_PORT` che hai impostato in `client_config.toml` (ad esempio `18000`).
- Se l'autenticazione SOCKS è abilitata in phantomdns, inserisci qui lo stesso nome utente/password.
...
- In **Outbound Tags**, seleziona il tag `phantomdns-Out`.
- Clicca **Save** e **Restart Xray**.

Ora tutto il traffico per quell'inbound passerà attraverso phantomdns e uscirà tramite il tuo tunnel DNS.

---

## Sezione 6: 🛠️ Architettura del Sistema e Come Funziona

**phantomdns** combina Session Multiplexing, Resolver Balancing, Packet Duplication, un livello ARQ personalizzato e un Deferred Session Runtime sopra UDP/DNS per evitare le solite limitazioni dei tunnel ordinari.
...
Sviluppato con ❤️ da: [**DrAlanK**](https://github.com/DrAlanK)
