...
func TestParseClientCLIArgsIgnoresExecutableInjectedAsPositionalConfig(t *testing.T) {
	withClientTestArgs(t, []string{"/data/data/com.termux/files/home/MasterDNS/phantomdns_Client_Termux_ARM64"}, func() {
		opts, overrides, err := parseClientCLIArgs([]string{"/data/data/com.termux/files/home/MasterDNS/phantomdns_Client_Termux_ARM64"}, &bytes.Buffer{})
		if err != nil {
			t.Fatalf("parseClientCLIArgs returned error: %v", err)
		}
		if opts.configPath != "client_config.toml" {
