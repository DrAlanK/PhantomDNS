...
import (
	...
	"golang.org/x/crypto/curve25519" // 🚀 اضافه شده برای هندشیک کلید عمومی نامتقارن

	baseCodec "phantomdns-go/internal/basecodec"
...
// ==============================================================================
// 🚀 GHOST MODE (Asymmetric Key Exchange - X25519)
// ==============================================================================

// GenerateX25519KeyPair یک جفت کلید خصوصی و عمومی برای کلاینت یا سرور می‌سازد
...
// ComputeX25519SharedSecret با استفاده از کلید خصوصی خودمان و کلید عمومی طرف مقابل،
// یک کلید مشترک (Shared Secret) تولید می‌کند که هیچ‌کس در میانه راه نمی‌تواند آن را شنود کند.
func ComputeX25519SharedSecret(privateKey, peerPublicKey []byte) ([]byte, error) {
	...
	// برای امنیت بیشتر و توزیع یکنواخت، کلید مشترک را هش می‌کنیم تا تبدیل به کلید نشست (Session Key) شود
