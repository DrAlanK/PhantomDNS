...
// Year: 2026
// ==============================================================================
// Package client provides the core logic and initialization for the phantomdns client.
...
func BootstrapLoadedConfig(cfg config.ClientConfig, logPath string) (*Client, error) {
	...
	if logPath != "" {
		log = logger.NewWithFile("phantomdns Client", cfg.LogLevel, logPath)
	} else {
		log = logger.New("phantomdns Client", cfg.LogLevel)
	}
