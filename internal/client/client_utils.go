...
// Year: 2026
// ==============================================================================
// Package client provides the core logic for the phantomdns client.
...
func (c *Client) ShortPrintBanner() {
	...
	c.log.Infof("============================================================")
	c.log.Infof("<cyan>GitHub:</cyan> <yellow>https://github.com/DrAlanK/phantomdns</yellow>")
	c.log.Infof("<cyan>Telegram:</cyan> <yellow>@phantomdns</yellow>")
