# phantomdns Benchmark Suite

This directory contains the core benchmarking tools for phantomdns, now enhanced with high-precision timing and standalone tool capabilities inspired by the `slipstream-rust` methodology.
...
To run a standard end-to-end benchmark through the phantomdns tunnel:
